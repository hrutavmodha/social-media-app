...
### 0.1 Root Scaffold
- [ ] Create the top-level folder structure: `server/`, `client/web/`, `client/mobile/android/`, `client/mobile/ios/`, `client/desktop/linux/`, `client/desktop/macos/`, `client/desktop/windows/`.
