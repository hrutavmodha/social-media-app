...
### 0.1 Root Scaffold
- [WIP 6] Create the top-level folder structure: `server/`, `client/web/`, `client/mobile/android/`, `client/mobile/ios/`, `client/desktop/linux/`, `client/desktop/macos/`, `client/desktop/windows/`.
- [ ] Add root `.gitignore` covering Go, Kotlin, Swift, C, C++, and web build artifacts.
